    ...
    return (
      <div className='landingPage'>
        ...
        <div className='titleCs'>
          <h3>Curieux Home</h3>
          <button className="btn" onClick={this.handleClick}>Events</button>
        </div>
        ...
        <div id='#about' className="about">
          <Grid container spacing={24}>
            <Grid item xs={12} sm={6}>
              ...
              <Link to="/about">Tell me something more</Link>
            </Grid>
            <Grid item xs={12} sm={6}>
        ...
        <Grid container spacing={24}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <button className="btn-white" onClick={this.handleClick}>Events</button>
            </Grid>
          </Grid>
        </div>
	  ...
	  <p>Special thanks to <a href="https://github.com/sankalploomba" target="_blank">Sankalp Loomba</a></p>
